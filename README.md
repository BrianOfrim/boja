...
### Train
Training is done using pyTorch with torchvision. It is based off of the torchvision  detection reference: https://github.com/pytorch/vision/tree/master/references/detection  
